        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('setprofile') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="datepicker" type="text" class="form-control" name="datepicker" value="{{ old('dob') }}" required autofocus placeholder="MM/DD/YYYY">
                            </div>
